...
export default function Tasks() {
  ...
  const statusOptions: FilterOption[] = [
    { label: 'All', value: 'all' },
    { label: `To Do (${taskCounts.todo})`, value: 'todo', count: taskCounts.todo },
    { label: `In Progress (${taskCounts.in_progress})`, value: 'in_progress', count: taskCounts.in_progress },
    { label: `Completed (${taskCounts.complete})`, value: 'complete', count: taskCounts.complete },
  ];
      ...
      <View style={styles.taskContent}>
        ...
        <View style={styles.taskMeta}>
          ...
          <View style={styles.taskBadges}>
            <View style={[
              styles.statusBadge,
              task.status === 'todo' ? styles.todoStatus :
              task.status === 'in_progress' ? styles.inProgressStatus :
          ...
          <View style={styles.filterSection}>
            ...
            {urgencyOptions.map((option) => (
              ...
              >
                <Text style={[
                  styles.filterOptionText,
                  urgencyFilter === option.value && styles.filterOptionTextSelected
                ]}>
                  {option.label}
                </Text>
        ...
        {filteredTasks.length === 0 ? (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>
              {showCompleted ? 'No tasks match your current filters' : 'All tasks completed!'}
            </Text>
          </View>
        ) : (
